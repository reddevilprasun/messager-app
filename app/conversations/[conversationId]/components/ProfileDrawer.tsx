...
import ConfirmModel from "@/app/components/ConfirmModel";
...
const ProfileDrawer: React.FC<ProfileDrawerProps> = ({
    ...
    const joinDate = useMemo(() => {
        return format(new Date(otherUser.creatAt), 'PP')
    }, [otherUser.creatAt])
    const titel = useMemo(() => {
                                            ...
                                            <div className="px-4 sm:px-6">
                                                <div className="flex items-start justify-end">
                                                    <div className="ml-3 flex h-7 items-center">
                                                        <button onClick={onClose} className="rounded-md bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus:right-2 focus:ring-sky-500 focus:ring-offset-2">
